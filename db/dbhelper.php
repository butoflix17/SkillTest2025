<?php
	...
	///
	/* $sql="CREATE TABLE `students`(`id` INTEGER PRIMARY KEY AUTOINCREMENT,`idno` VARCHAR(10),`lastname` VARCHAR(50),`firstname` VARCHAR(50),`course` VARCHAR(10),`level` VARCHAR(5))";
	postprocess($sql); */
